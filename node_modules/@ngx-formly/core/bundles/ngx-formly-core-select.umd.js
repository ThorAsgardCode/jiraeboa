(function (global, factory) {
    ...
    var FormlySelectOptionsPipe = /** @class */ (function () {
         ...
         * @return {?}
         */
        FormlySelectOptionsPipe.prototype.ngOnDestroy = /**
         * @return {?}
         */
            function () {
                this.dispose();
         ...
         * @return {?}
         */
        FormlySelectOptionsPipe.prototype.dispose = /**
         * @private
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        FormlySelectOptionsPipe.prototype.observableOf = /**
         * @private
         * @param {?} options
         * @param {?=} f
         * @return {?}
         */
            function (options, f) {
                ...
                if (f && f.options && f.options.fieldChanges) {
                    this._subscription = f.options.fieldChanges.pipe(operators.filter(( /**
                     * @param {?} __0
                     * @return {?}
                     */function (_a) {
                        var property = _a.property, type = _a.type, field = _a.field;
                     ...
                     * @return {?}
                     */function () { return _this._options.next(( /** @type {?} */(f.templateOptions.options))); }))).subscribe();
                }
                this._options = new rxjs.BehaviorSubject(options);
